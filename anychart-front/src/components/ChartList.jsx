          ...
          {charts.map(chart => (
            ...
            >
              <div className="chart-card-header">
                <div className="chart-card-icon" style={{ background: CHART_TYPE_COLORS[chart.chartType] }}>
        ...
        <div className="chart-preview-modal" onClick={() => setShowPreview(false)}>
          <div className="preview-modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="preview-modal-footer">
              ...
              <button className="primary-btn" onClick={() => { setShowPreview(false); handleEdit(selectedChart); }}>
                编辑图表
              </button>
            </div>
          </div>
